...
from aitsm.core.database import get_db
from aitsm.models.user import User
from aitsm.routers.auth import get_current_user
from aitsm.schemas.kb_article import (
    FeedbackCreate,
    KBArticleCreate,
    KBArticleOut,
    KBArticleUpdate,
...
from aitsm.services.kb_service import (
    add_feedback,
    create_article,
    get_article,
    list_articles,
...
from aitsm.vector.chroma_client import delete_article
...
@router.post("/{article_id}/feedback", response_model=KBArticleOut)
def feedback(
    article_id: str,
