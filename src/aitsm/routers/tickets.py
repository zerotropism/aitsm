...
from aitsm.schemas.ticket import TicketCreate, TicketList, TicketOut, TicketUpdate
from aitsm.schemas.ticket_comment import CommentCreate, CommentOut
from aitsm.services.ticket_service import (
    add_comment,
    create_ticket,
    get_ticket,
    list_comments,
